<?php
/**
 * Icon set - one cohesive line family (Lucide, MIT). 24x24 viewBox, 2px stroke,
 * round caps/joins, no fills; stroke is currentColor. The WatchLog W monogram
 * (mark.svg) is a brand mark, never used here as a generic icon.
 */
...
function watchlog_icon($name, $size = 24, $class = '') {
    ...
    'recorder' => '<path d="M10 16h.01"/><path d="M2.212 11.577a2 2 0 0 0-.212.896V18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5.527a2 2 0 0 0-.212-.896L18.55 5.11A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><path d="M21.946 12.013H2.054"/><path d="M6 16h.01"/>',
    ...
    'whatsapp' => '<path d="M3.8 20.2l1.2-4.2A8 8 0 1 1 8.2 19z"/><path d="M9.2 9.4c-.3 1.6 2 4.9 4 5.3.7.1 1.6-.5 1.8-1.2l-1.6-.9-.9.9c-1-.4-2-1.4-2.4-2.4l.9-.9-.9-1.6c-.7.2-.8.5-.9.8z"/>',
    ];
