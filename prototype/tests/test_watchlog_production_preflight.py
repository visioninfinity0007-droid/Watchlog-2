...
def base_markers():
    return {
        "entitlement_0023":True,"reporting_0023":True,
        "monitoring_rules_0024":False,"site_type_0024":False,"camera_purpose_0024":False,
        "platform_admins_0029":False,"platform_me_0029":False,"analytic_key_0030":False,
        "recipient_destinations_0031":False,"site_health_0033":False,"billing_owner_policies_0036":False,
        "commercial_invoices_0037":False,"support_sessions_0037":False,"platform_commercial_0037":False,
        "account_status_0038":False,"my_account_0038":False,"account_lifecycle_0038":False,
        "control_room_layouts_0039":False,"control_room_layout_rpc_0039":False,
        "incident_clip_requests_0040":False,"incident_clip_chunks_0040":False,"incident_clip_agent_rpc_0040":False,
        "incident_clip_fail_hardened_0041":False,
    }


def set_through_0036(m):
    for key in ("monitoring_rules_0024","site_type_0024","camera_purpose_0024","platform_admins_0029","platform_me_0029","analytic_key_0030","recipient_destinations_0031","site_health_0033","billing_owner_policies_0036"):m[key]=True


def set_0037(m):
    for key in ("commercial_invoices_0037","support_sessions_0037","platform_commercial_0037"):m[key]=True


def set_0038(m):
    for key in ("account_status_0038","my_account_0038","account_lifecycle_0038"):m[key]=True


def set_0039(m):
    for key in ("control_room_layouts_0039","control_room_layout_rpc_0039"):m[key]=True


def set_0040(m):
    for key in ("incident_clip_requests_0040","incident_clip_chunks_0040","incident_clip_agent_rpc_0040"):m[key]=True
...
def test_partial_0040_without_hardening_stops():
    m=base_markers();set_through_0036(m);set_0037(m);set_0038(m);set_0039(m);set_0040(m)
    assert preflight.classify_boundary(m)=="partial_after_0039_stop_and_reconcile"


def test_0041_candidate_requires_footage_smoke():
    m=base_markers();set_through_0036(m);set_0037(m);set_0038(m);set_0039(m);set_0040(m);m["incident_clip_fail_hardened_0041"]=True
    assert preflight.classify_boundary(m)=="0041_candidate_requires_footage_smoke"
...
def test_target_guard_rejects_other_project():
    try:preflight.validate_target("jssitaduuhjvyznldfoc","db.jssitaduuhjvyznldfoc.supabase.co","postgres.jssitaduuhjvyznldfoc")
    except RuntimeError as exc:assert "expected WatchLog project" in str(exc)
...
def test_target_guard_rejects_mismatched_connection_metadata():
    try:preflight.validate_target(preflight.EXPECTED_PROJECT_REF,f"db.{preflight.EXPECTED_PROJECT_REF}.supabase.co","postgres.jssitaduuhjvyznldfoc")
    except RuntimeError as exc:assert "database user does not match" in str(exc)
