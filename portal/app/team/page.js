...
export default function Team(){
  ...
  async function revoke(id){const{error}=await supabase().rpc("wl_revoke_invite",{p_id:id});if(error)setErr(say(error));else setNote("Invitation revoked.");load();}
